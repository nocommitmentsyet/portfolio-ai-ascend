      ...
      <div className="flex flex-col space-y-8">
        <div>
          ...
          <p className="text-muted-foreground text-lg">
            Generate a tailored cover letter in seconds using AI that matches the job description.
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <Textarea 
                ...
                className="min-h-[400px] p-4 font-sans text-base leading-relaxed"
              />
            </CardContent>
            <CardFooter>
              <Button 
                onClick={downloadCoverLetter}
                className="bg-portfolioai-bright-blue hover:bg-blue-600"
              >
